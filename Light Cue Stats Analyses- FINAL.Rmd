...
We can access this dataset from my Github repository as follows:
```{r}
library(curl)
f <- curl("https://raw.githubusercontent.com/bguell/Red-eyed-treefrogs-use-light-cues/master/Diel%20Hatching%20Pattern%20Data.csv")
...
First, we can load this straight from my personal Github repository as follows:
```{r}
library(curl)
f <- curl("https://raw.githubusercontent.com/bguell/Red-eyed-treefrogs-use-light-cues/master/Hatching%20Orientation%20Data.csv")
